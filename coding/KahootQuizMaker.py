...
if __name__ == "__main__":
    ...
    if tester == 'jonas':
        ...
        qm = KahootQuizMaker("jvbrink", path="", loglvl=logging.INFO)

        # Example of reading .quiz file, then making and uploading a kahoot quiz
        #questions = qm.read_quiz_file(".final_quiz.quiz")
        #quiz = qm.make_quiz(questions, quiz_format='modern', default_time=60000, visibility=1, title='Programmeringsquiz!')
