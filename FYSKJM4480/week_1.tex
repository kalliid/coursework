...
We can find the eigenvalues and eigenvectors by using a symbolic programming tool like wolfram alpha or sympy. The results is quite long and messy, so we won't include it here. But you can see it by following this link: \\ 
\url{http://bit.ly/1qvsv5r}.
