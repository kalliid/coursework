...
Wh = array([804, 813, 455, 393, 301, 239, 163, 113, 79, 96, 171, 258, 329, 417, 483, 660, 792, 951, 1260, 1544]) # [mikro m]
Wv = array([808, 815, 454, 394, 301, 236, 163, 112, 79, 94, 174, 260, 338, 421, 492, 657, 786, 957, 1260, 1566]) # [mikro m]
...
# Find fit for the first part
x1 = linspace(0, 200, 201)
x2 = linspace(200, 500, 301)
x3 = linspace(500,505, 6)
W = (Wh + Wv)/2.
w0 = W[0]
...
axvline(x=500, ymin=0, ymax=1, linewidth=2, color='r', linestyle="--")
grid()
