...
\begin{frame}[fragile]
{\Huge \color{DarkFern} Ingen laserstråle har konstant bredde}
\begin{center}
\vspace{0.2cm}
...
\begin{frame}[fragile]
{\Huge \color{DarkFern} Linser endrer krumningsradien}
\begin{center}
\vspace{0.2cm}
...
\begin{frame}[fragile]
{\Huge \color{DarkFern} Vi kan lage en beam expander fra to bikonvekse linser}
\begin{center}
\vspace{0.2cm}
