...
l = array([242, 252, 262, 272, 282, 292, 302, 312, 322, 332, 342, 352, 362, 382, 402, 422, 462, 502])
W_hor = array([455, 393, 301, 239, 163, 113, 79, 96, 171, 258, 329, 417, 483, 660, 792, 951, 1260, 1544]) # [mikro m]
W_vert = array([454, 394, 301, 236, 163, 112, 79, 94, 174, 260, 338, 421, 492, 657, 786, 957, 1260, 1566]) # [mikro m]

# Dataset 1
l1 = array([242, 252, 262, 272, 282, 292, 302, 312, 322, 332, 342, 352, 362, 382, 402, 422, 462, 502, 547, 567, 587, 672, 772, 887, 1019])
Wh1 = array([455, 393, 301, 239, 163, 113, 79, 96, 171, 258, 329, 417, 483, 660, 792, 951, 1260, 1544, 1545, 1545, 1552, 1571, 1593, 1606, 1620])/2. # [mikro m]
Wv1 = array([454, 394, 301, 236, 163, 112, 79, 94, 174, 260, 338, 421, 492, 657, 786, 957, 1260, 1566, 1561, 1542, 1562, 1572, 1561, 1600, 1628])/2. # [mikro m]

# Dataset 2
l2 = array([242, 252, 262, 272, 282, 292, 302, 312, 322, 332, 342, 352, 362, 382, 402, 422, 462, 502, 548, 557, 657, 757, 857, 1084, 1209, 1509, 2059, 2559])
Wh2 = array([455, 393, 301, 239, 163, 113, 79, 96, 171, 258, 329, 417, 483, 660, 792, 951, 1260, 1544, 1560, 1561, 1557, 1579, 1590, 1595, 1594, 1613, 1651, 1745])/2.
Wv2 = array([454, 394, 301, 236, 163, 112, 79, 94, 174, 260, 338, 421, 492, 657, 786, 957, 1260, 1566, 1597, 1600, 1580, 1586, 1580, 1605, 1626, 1650, 1700, 1836])/2.

# Dataset 3
l3 =  array([242, 252, 262, 272, 282, 292, 302, 312, 322, 332, 342, 352, 362, 382, 402, 422, 462, 502, 552, 622, 722, 822, 1084, 1184, 1284, 1509, 1859, 2159, 2609])
Wv3 = array([454, 394, 301, 236, 163, 112, 79, 94, 174, 260, 338, 421, 492, 657, 786, 957, 1260, 1566, 1592, 1580, 1570, 1571, 1551, 1564, 1561, 1559, 1551, 1558, 1591])/2.
Wh3 = array([455, 393, 301, 239, 163, 113, 79, 96, 171, 258, 329, 417, 483, 660, 792, 951, 1260, 1544, 1580, 1576, 1574, 1565, 1522, 1511, 1501, 1500, 1474, 1459, 1464])/2.
...
for i in range(3):
	...
	def error(y):
		R0, w0, eps = y
		x, Wfit = calculate_beam(R0, w0, eps)
	...
	R0fit, w0, eps = leastsq(error, (-10**4, 393, 0))[0]
	print "Least squares estimations of Dataset 1:"
	print "R0: %.2e" % R0fit
	print "w0: %.2e" % w0
	print "eps: %.2e" % eps

	x, Wfit = calculate_beam(R0fit, w0, eps)
	...
	legend(['Measurements', 'Best TMA Fit', 'Lens location'], 'lower right', fontsize=20)
